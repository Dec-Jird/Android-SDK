 ...
 *
 */
@SuppressLint("NewApi") public class IabHelper {
    ...
    public interface OnIabPurchaseFinishedListener {
         ...
         */
        void onIabPurchaseFinished(IabResult result, String dataStr,
				String sigStr);
    }
...
//        String skuDetails = null;
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
			...
			try {
		        ...
		        Bundle skuDetailBundle = mService.getSkuDetails(3, mContext.getPackageName(), "inapp", querySkus);
		        ArrayList<String> responseList = skuDetailBundle.getStringArrayList("DETAILS_LIST");
		        skuDetails = responseList.get(0);
		        
		        logDebug("-> Sku Details: " + skuDetails);
//		        Tapjoy.trackPurchase(skuDetails, purchaseData, dataSignature, null);
            ...
            try {
                ...
                if (!Security.verifyPurchase(mSignatureBase64, purchaseData, dataSignature)) {
                    ...
                    if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, purchaseData, dataSignature);
                    return true;
                }
            ...
            if (mPurchaseListener != null) {
                mPurchaseListener.onIabPurchaseFinished(new IabResult(BILLING_RESPONSE_RESULT_OK, "Success"), purchaseData, dataSignature);
            }
        }
