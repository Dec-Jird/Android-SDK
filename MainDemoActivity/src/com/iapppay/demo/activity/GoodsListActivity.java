...
public class GoodsListActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.ll_btn5).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_btn4:
                ...
                break;
            case R.id.ll_btn5:
                startPay(GoodsListActivity.this, getTransdata(appuserid, cpprivateinfo , waresid_auto_fee , 10, cporderid));
                break;
    ...
    public void startPay(Activity activity, String param) {
        boolean isOpenidLogin = getIntent().getBooleanExtra("isOpenidLogin", false);
        if(isOpenidLogin){
            JSONObject voucher = IpayOpenidApi.getInstance().getVoucher_AppId(this);
            if(voucher!=null){
                IAppPay.startPay(activity, param, voucher, iPayResultCallback);
                Log.d("", "startPay openid");
            }else{
                Toast.makeText(this, "voucher is null", Toast.LENGTH_SHORT).show();
            }
        }else{
        ...
        public void onPayResult(int resultCode, String signvalue, String resultInfo) {
            ...
            switch (resultCode) {
                ...
                case IAppPay.PAY_ING:
                    Toast.makeText(GoodsListActivity.this, "成功下单", Toast.LENGTH_LONG).show();
                    break ;
                default:
