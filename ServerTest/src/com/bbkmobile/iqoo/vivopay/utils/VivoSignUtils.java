...
public class VivoSignUtils {
	...
	public static boolean verifySignature(Map<String, String> para, String key) {
		...
		System.out.println("服务器签名：" + signature + " | 请求消息中的签名："
				+ respSignature);
		// 对比签名值
	...
	public static void main(String[] args) {
		String cpKey = "fa4a5c348e37d2eaf56a0001e30243de";
		String requestUrl = "https://pay.vivo.com.cn/vcoin/trade";
		String version = "1.0.0";
		String signMethod = "MD5";
		String cpId = "20150506165431733076";
		String appId = "4f00a8c18074b6ca58eae73f3f30f5b3";
		String cpOrderNumber = ""+(System.currentTimeMillis());
		String notifyUrl = "http://127.0.0.1:8080/vivopay/vivoPay/testNotify";
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
		String orderTime = sdf.format(new Date());
		String orderAmount = "600";
		String orderTitle = "60元宝";
		String orderDesc = "60元宝";
		String extInfo = "tnyoovivovivopay";

		 String signStr = "appId="+appId+"&cpId="+cpId+"&cpOrderNumber="+cpOrderNumber+"&extInfo="+extInfo+
		 ...
		 String signature = md5Summary(signStr+"&"+md5Summary(cpKey).toLowerCase()).toLowerCase();
		 System.out.println("签名: \n\t" + signature);

		 signStr = "accessKey=c86518258ef91caacd38edef4bde2a54&orderAmount=600&orderNumber=2016041409405452300018821554&respCode=200&respMsg=success";
		 System.out.println("待签名串: \n" + signStr);

		 signature = md5Summary(signStr+"&"+md5Summary(cpKey).toLowerCase()).toLowerCase();
		 System.out.println("签名: \n\t" + signature);//6be0450768de547c5426bc4e3d49e685
...
//		String key = "123456789123456";
		...
		String sign = getVivoSign(para, cpKey);
		System.out.println("vivo签名值串：" + para);
		System.out.println("vivo签名值：" + sign);

		boolean verify = verifySignature(para, cpKey);
