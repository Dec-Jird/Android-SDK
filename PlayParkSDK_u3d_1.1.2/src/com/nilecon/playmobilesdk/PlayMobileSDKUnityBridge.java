...
/**
 * Created by Rawit on 3/4/2016 AD. extends UnityPlayerActivity
 */
public class PlayMobileSDKUnityBridge {
	...
	public static void init(String gameObjectName) {
		...
		Log.d(PPSConstants.LOG_TAG,
				"Unity-Bridge init Bridge currentActivity: "
						+ PlayMobileSDKUnityBridge.currentActivity
						+ " ,gameObjectName: " + gameObjectName);
	}

	public static void initPartnerCode(final String partnerCode) {
		Log.d(PPSConstants.LOG_TAG,
				"Unity-Bridge initPartnerCode partnerCode: " + partnerCode);
	...
	public static PlayMobileSDKInternal.RequestLoginCallback onRequestLoginPlayMobileWithPackageNameCallback = new PlayMobileSDKInternal.RequestLoginCallback() {
		...
		public void onSuccess(String userId, String token) {
			Log.d(PPSConstants.LOG_TAG,
					"Unity-Bridge requestLoginPlaymobileWithPackageName-onSuccess  before parse Data with userId : "
							+ userId + " token :" + token);
			Map<String, String> data = new HashMap<String, String>();
			Log.d(PPSConstants.LOG_TAG,
					"Unity-Bridge requestLoginPlaymobileWithPackageName-onSuccess  new HashMap");
			data.put("userId", userId);
			data.put("token", token);
			Log.d(PPSConstants.LOG_TAG,
					"Unity-Bridge requestLoginPlaymobileWithPackageName-onSuccess  affter Put data to HashMap");
			JSONObject json = new JSONObject(data);
			// Gson gson = new Gson();
			Log.d(PPSConstants.LOG_TAG,
					"Unity-Bridge requestLoginPlaymobileWithPackageName-onSuccess Parse JSONObject :"
							+ json.toString());
			...
			UnityPlayer
					.UnitySendMessage(
							gameObjectName,
							ON_REQUEST_LOGIN_PLAYMOBILE_WITH_PACKAGENAME_SUCCESS_CALLBACK,
							jsonText);
			Log.d(PPSConstants.LOG_TAG,
					"Unity-Bridge requestLoginPlaymobileWithPackageName-onSuccess userId : "
							+ userId + " token :" + token);
		}
		...
		public void onFailure(String message) {
			...
			UnityPlayer
					.UnitySendMessage(
							gameObjectName,
							ON_REQUEST_LOGIN_PLAYMOBILE_WITH_PACKAGENAME_FAILURE_CALLBACK,
							message);
			Log.d(PPSConstants.LOG_TAG,
					"Unity-Bridge requestLoginPlaymobileWithPackageName-onFailure message : "
							+ message);
		}
		...
		public void onPlayMobile(boolean canopen, String message) {
			...
			Log.d(PPSConstants.LOG_TAG,
					"Unity-Bridge requestLoginPlaymobileWithPackageName-onPlayMobile message : "
							+ message);
		}
	};
	...
	public static PlayMobileSDKInternal.RequestReceiveCallback onRequestReceiveCallback = new PlayMobileSDKInternal.RequestReceiveCallback() {
		...
		public void onSuccess(String userId, String token) {
			...
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_RECEIVE_SUCCESS_CALLBACK, jsonText);
			Log.d(PPSConstants.LOG_TAG,
					"Unity-Bridge onRequestReceiveCallback-onSuccess userId : "
							+ userId + " token :" + token);
		}
		...
		public void onFailure(String message) {
			super.onFailure(message);
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_RECEIVE_FAILURE_CALLBACK, message);
		}
	};
	...
	public static PlayMobileSDKInternal.RequestLogoutCallback onRequestLogoutCallback = new PlayMobileSDKInternal.RequestLogoutCallback() {
		...
		public void onSuccess(String message) {
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_LOGOUT_PLAYMOBILE_SUCCESS_CALLBAK, message);
		}
		...
		public void onFailure(String message) {
			super.onFailure(message);
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_LOGOUT_PLAYMOBILE_FAILURE_CALLBAK, message);
		}
	};
	public static PlayMobileSDKInternal.RequestBinderAccountCallback onRequestBindAccountCallback = new PlayMobileSDKInternal.RequestBinderAccountCallback() {
		...
		public void onSuccess(String userId, String token) {
			...
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_BINDACCOUNT_SUCCESS_CALLBACK, jsonText);
			Log.d(PPSConstants.LOG_TAG,
					"Unity-Bridge onRequestBindAccountCallback-onSuccess userId : "
							+ userId + " token :" + token);
		}
		...
		public void onFailure(String message) {
			...
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_BINDACCOUNT_FAILURE_CALLBACK, message);
			Log.d(PPSConstants.LOG_TAG,
					"Unity-Bridge onRequestBindAccountCallback-onFailure message : "
							+ message);
		}
	};
	...
	public static PlayMobileSDKInternal.RequestWebTopupCallback onRequestWebTopupCallback = new PlayMobileSDKInternal.RequestWebTopupCallback() {
		...
		public void onSuccess() {
			...
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_WEBTOPUP_SUCCESS_CALLBACK, message);
		}
		...
		public void onFailure(String message) {
			super.onFailure(message);
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_WEBTOPUP_FAILURE_CALLBACK, message);
		}
	};
	...
	public static PlayMobileSDKInternal.RequestWalletPaymentCallback onRequestWalletPaymentCallback = new PlayMobileSDKInternal.RequestWalletPaymentCallback() {
		...
		public void onSuccess(String token) {
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_WALLETPAYMENT_SUCCESS_CALLBACK, token);
		}
		...
		public void onFailure(String message) {
			super.onFailure(message);
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_WALLETPAYMENT_FAILURE_CALLBACK, message);
		}
	};
	...
	public static PlayMobileSDKInternal.RequestPaymentCallback onRequestPaymentCallback = new PlayMobileSDKInternal.RequestPaymentCallback() {
		...
		public void onSuccess(String token) {
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_PAYMENT_SUCCESS_CALLBACK, token);
		}
		...
		public void onFailure(String message) {
			super.onFailure(message);
			UnityPlayer.UnitySendMessage(gameObjectName,
					ON_REQUEST_PAYMENT_FAILURE_CALLBACK, message);
		}
	};

	public static void requestLoginPlaymobileWithPackageName(
			final String partnerCode, final int domainInt, final String action) {
		...
		mActivity.runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				PPSConstants.DomainType domainType = PPSConstants.DomainType
						.values()[domainInt];
				Log.d(PPSConstants.LOG_TAG,
						"Unity-Bridge requestLoginPlaymobileWithPackageName partnerCode : "
								+ partnerCode + " action :" + action);
				PlayMobileSDK.requestLoginPlaymobileWithPackageName(
						currentActivity, partnerCode, domainType, action,
						onRequestLoginPlayMobileWithPackageNameCallback);
			}
	...
	public static void requestAutoLoginPlayMobileWithPackageName(
			String partnerCode) {
		PlayMobileSDK.requestAutoLoginPlaymobileWithPackageName(
				currentActivity, partnerCode,
				onRequestLoginPlayMobileWithPackageNameCallback);
	}

	public static void getReceiveParameterWithIntent() {
		PlayMobileSDK.getReceiveParameterWithIntent(currentActivity,
				onRequestReceiveCallback);
	}
	...
	public static void requestLogoutPlayMobile() {
		...
		PlayMobileSDK.requestLogoutPlaymobile(currentActivity,
				onRequestLogoutCallback);
	}
	...
	public static void requestBindAccount() {
		...
		PlayMobileSDK.requestBinderAccount(currentActivity,
				onRequestBindAccountCallback);
	...
	public static void initWalletPayment(String merchantCode, String merchantKey) {
		...
		PlayMobileSDK.initWalletPayment(currentActivity, merchantCode,
				merchantKey);
	}
	...
	public static void initPaymentAndWalletPayment(String paymentMerchantCode,
			String paymentMerchantKey, String walletMerchantCode,
			String walletMerchantKey) {
		Log.d(PPSConstants.LOG_TAG, "Unity-Bridge initPaymentAndWalletPayment");
		PlayMobileSDK.initPaymentAndWalletPayment(currentActivity,
				paymentMerchantCode, paymentMerchantKey, walletMerchantCode,
				walletMerchantKey);
	}

	public static void requestWebTopup(PPSConstants.WebTopUpMode mode) {
		Log.d(PPSConstants.LOG_TAG, "Unity-Bridge requestWebTopup");
		PlayMobileSDK.requestWebTopup(currentActivity, mode,
				onRequestWebTopupCallback);
	}

	public static void requestWalletPayment(String transactionId,
			String customerId, String itemName, String itemAmount,
			String itemCurrency) {
		Log.d(PPSConstants.LOG_TAG, "Unity-Bridge requestWalletPayment");
		PlayMobileSDK.requestWalletPayment(currentActivity, transactionId,
				customerId, itemName, itemAmount, itemCurrency,
				onRequestWalletPaymentCallback);
	}
	...
	public static void requestPayment(String transactionId, String customerId) {
		...
		PlayMobileSDK.requestPayment(currentActivity, transactionId,
				customerId, onRequestPaymentCallback);
	}
}
